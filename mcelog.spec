...
Version  : 187
Release  : 65
URL      : https://github.com/andikleen/mcelog/archive/v187/mcelog-187.tar.gz
Source0  : https://github.com/andikleen/mcelog/archive/v187/mcelog-187.tar.gz
...
%prep
%setup -q -n mcelog-187
cd %{_builddir}/mcelog-187
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659969142
