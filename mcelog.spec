...
Version  : 169
Release  : 49
URL      : https://github.com/andikleen/mcelog/archive/v169/mcelog-169.tar.gz
Source0  : https://github.com/andikleen/mcelog/archive/v169/mcelog-169.tar.gz
...
%prep
%setup -q -n mcelog-169
cd %{_builddir}/mcelog-169
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1588116695
...
cp %{_builddir}/mcelog-169/LICENSE %{buildroot}/usr/share/package-licenses/mcelog/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
