...
Version  : 204
Release  : 82
URL      : https://github.com/andikleen/mcelog/archive/v204/mcelog-204.tar.gz
Source0  : https://github.com/andikleen/mcelog/archive/v204/mcelog-204.tar.gz
...
%prep
%setup -q -n mcelog-204
cd %{_builddir}/mcelog-204
%patch -P 1 -p1
pushd ..
cp -a mcelog-204 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739812341
