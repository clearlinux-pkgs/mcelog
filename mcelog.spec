...
Version  : 178
Release  : 57
URL      : https://github.com/andikleen/mcelog/archive/v178/mcelog-178.tar.gz
Source0  : https://github.com/andikleen/mcelog/archive/v178/mcelog-178.tar.gz
...
%prep
%setup -q -n mcelog-178
cd %{_builddir}/mcelog-178
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1626876000
...
cp %{_builddir}/mcelog-178/LICENSE %{buildroot}/usr/share/package-licenses/mcelog/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
