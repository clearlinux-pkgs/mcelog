...
Version  : 170
Release  : 50
URL      : https://github.com/andikleen/mcelog/archive/v170/mcelog-170.tar.gz
Source0  : https://github.com/andikleen/mcelog/archive/v170/mcelog-170.tar.gz
...
%prep
%setup -q -n mcelog-170
cd %{_builddir}/mcelog-170
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1590721825
...
cp %{_builddir}/mcelog-170/LICENSE %{buildroot}/usr/share/package-licenses/mcelog/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
