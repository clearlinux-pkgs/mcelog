...
Version  : 198
Release  : 77
URL      : https://github.com/andikleen/mcelog/archive/v198/mcelog-198.tar.gz
Source0  : https://github.com/andikleen/mcelog/archive/v198/mcelog-198.tar.gz
...
%prep
%setup -q -n mcelog-198
cd %{_builddir}/mcelog-198
%patch -P 1 -p1
pushd ..
cp -a mcelog-198 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711637652
