...
Version  : 175
Release  : 54
URL      : https://github.com/andikleen/mcelog/archive/v175/mcelog-175.tar.gz
...
%prep
%setup -q -n mcelog-175
cd %{_builddir}/mcelog-175
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610129353
...
cp %{_builddir}/mcelog-175/LICENSE %{buildroot}/usr/share/package-licenses/mcelog/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
