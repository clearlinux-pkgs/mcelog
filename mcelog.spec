...
Source0  : https://github.com/andikleen/mcelog/archive/v188/mcelog-188.tar.gz
...
%prep
%setup -q -n mcelog-188
cd %{_builddir}/mcelog-188
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660579189
