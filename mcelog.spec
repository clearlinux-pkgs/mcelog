...
Version  : 199
Release  : 78
URL      : https://github.com/andikleen/mcelog/archive/v199/mcelog-199.tar.gz
Source0  : https://github.com/andikleen/mcelog/archive/v199/mcelog-199.tar.gz
...
%prep
%setup -q -n mcelog-199
cd %{_builddir}/mcelog-199
%patch -P 1 -p1
pushd ..
cp -a mcelog-199 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715903013
