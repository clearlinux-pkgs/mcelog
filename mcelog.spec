...
Version  : 172
Release  : 51
URL      : https://github.com/andikleen/mcelog/archive/v172/mcelog-172.tar.gz
Source0  : https://github.com/andikleen/mcelog/archive/v172/mcelog-172.tar.gz
...
%prep
%setup -q -n mcelog-172
cd %{_builddir}/mcelog-172
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1600443926
...
cp %{_builddir}/mcelog-172/LICENSE %{buildroot}/usr/share/package-licenses/mcelog/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
