...
Version  : 148
Release  : 24
URL      : https://github.com/andikleen/mcelog/archive/v148.tar.gz
Source0  : https://github.com/andikleen/mcelog/archive/v148.tar.gz
...
%prep
%setup -q -n mcelog-148
%patch1 -p1
%patch2 -p1

%build
export LANG=C
export SOURCE_DATE_EPOCH=1487260137
