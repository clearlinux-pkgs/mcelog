...
Version  : 190
Release  : 68
URL      : https://github.com/andikleen/mcelog/archive/v190/mcelog-190.tar.gz
Source0  : https://github.com/andikleen/mcelog/archive/v190/mcelog-190.tar.gz
...
%prep
%setup -q -n mcelog-190
cd %{_builddir}/mcelog-190
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667340921
