...
Version  : 200
Release  : 79
URL      : https://github.com/andikleen/mcelog/archive/v200/mcelog-200.tar.gz
Source0  : https://github.com/andikleen/mcelog/archive/v200/mcelog-200.tar.gz
...
%prep
%setup -q -n mcelog-200
cd %{_builddir}/mcelog-200
%patch -P 1 -p1
pushd ..
cp -a mcelog-200 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718665742
