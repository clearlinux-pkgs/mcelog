...
Version  : 184
Release  : 64
URL      : https://github.com/andikleen/mcelog/archive/v184/mcelog-184.tar.gz
Source0  : https://github.com/andikleen/mcelog/archive/v184/mcelog-184.tar.gz
...
%prep
%setup -q -n mcelog-184
cd %{_builddir}/mcelog-184
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656696115
...
cp %{_builddir}/mcelog-184/LICENSE %{buildroot}/usr/share/package-licenses/mcelog/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
