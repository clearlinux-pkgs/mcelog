...
Version  : 192
Release  : 71
URL      : https://github.com/andikleen/mcelog/archive/v192/mcelog-192.tar.gz
Source0  : https://github.com/andikleen/mcelog/archive/v192/mcelog-192.tar.gz
...
%prep
%setup -q -n mcelog-192
cd %{_builddir}/mcelog-192
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678719148
