...
Source0  : https://github.com/andikleen/mcelog/archive/v189/mcelog-189.tar.gz
...
%prep
%setup -q -n mcelog-189
cd %{_builddir}/mcelog-189
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661352910
