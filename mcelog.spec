...
Version  : 173
Release  : 52
URL      : https://github.com/andikleen/mcelog/archive/v173/mcelog-173.tar.gz
Source0  : https://github.com/andikleen/mcelog/archive/v173/mcelog-173.tar.gz
...
%prep
%setup -q -n mcelog-173
cd %{_builddir}/mcelog-173
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1600962762
...
cp %{_builddir}/mcelog-173/LICENSE %{buildroot}/usr/share/package-licenses/mcelog/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
