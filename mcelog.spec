...
Version  : 191
Release  : 70
URL      : https://github.com/andikleen/mcelog/archive/v191/mcelog-191.tar.gz
Source0  : https://github.com/andikleen/mcelog/archive/v191/mcelog-191.tar.gz
...
%prep
%setup -q -n mcelog-191
cd %{_builddir}/mcelog-191
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673624433
