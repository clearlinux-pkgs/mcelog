...
Version  : 176
Release  : 55
URL      : https://github.com/andikleen/mcelog/archive/v176/mcelog-176.tar.gz
Source0  : https://github.com/andikleen/mcelog/archive/v176/mcelog-176.tar.gz
...
%prep
%setup -q -n mcelog-176
cd %{_builddir}/mcelog-176
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619817889
...
cp %{_builddir}/mcelog-176/LICENSE %{buildroot}/usr/share/package-licenses/mcelog/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
