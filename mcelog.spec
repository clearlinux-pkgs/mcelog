...
Version  : 174
Release  : 53
URL      : https://github.com/andikleen/mcelog/archive/v174/mcelog-174.tar.gz
Source0  : https://github.com/andikleen/mcelog/archive/v174/mcelog-174.tar.gz
...
%prep
%setup -q -n mcelog-174
cd %{_builddir}/mcelog-174
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610057290
...
cp %{_builddir}/mcelog-174/LICENSE %{buildroot}/usr/share/package-licenses/mcelog/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
