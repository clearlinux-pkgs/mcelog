...
Version  : 168
Release  : 48
URL      : https://github.com/andikleen/mcelog/archive/v168/mcelog-168.tar.gz
Source0  : https://github.com/andikleen/mcelog/archive/v168/mcelog-168.tar.gz
...
%prep
%setup -q -n mcelog-168
cd %{_builddir}/mcelog-168
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578696941
...
cp %{_builddir}/mcelog-168/LICENSE %{buildroot}/usr/share/package-licenses/mcelog/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
