...
Version  : 181
Release  : 61
URL      : https://github.com/andikleen/mcelog/archive/v181/mcelog-181.tar.gz
Source0  : https://github.com/andikleen/mcelog/archive/v181/mcelog-181.tar.gz
...
%prep
%setup -q -n mcelog-181
cd %{_builddir}/mcelog-181
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1650325498
...
cp %{_builddir}/mcelog-181/LICENSE %{buildroot}/usr/share/package-licenses/mcelog/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
