...
Version  : 182
Release  : 62
URL      : https://github.com/andikleen/mcelog/archive/v182/mcelog-182.tar.gz
Source0  : https://github.com/andikleen/mcelog/archive/v182/mcelog-182.tar.gz
...
%prep
%setup -q -n mcelog-182
cd %{_builddir}/mcelog-182
%patch1 -p1
...
cp %{_builddir}/mcelog-182/LICENSE %{buildroot}/usr/share/package-licenses/mcelog/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
