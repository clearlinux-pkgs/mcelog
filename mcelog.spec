...
Version  : 201
Release  : 80
URL      : https://github.com/andikleen/mcelog/archive/v201/mcelog-201.tar.gz
Source0  : https://github.com/andikleen/mcelog/archive/v201/mcelog-201.tar.gz
...
%prep
%setup -q -n mcelog-201
cd %{_builddir}/mcelog-201
%patch -P 1 -p1
pushd ..
cp -a mcelog-201 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731694776
