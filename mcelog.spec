...
Version  : 183
Release  : 63
URL      : https://github.com/andikleen/mcelog/archive/v183/mcelog-183.tar.gz
Source0  : https://github.com/andikleen/mcelog/archive/v183/mcelog-183.tar.gz
...
%prep
%setup -q -n mcelog-183
cd %{_builddir}/mcelog-183
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656440468
...
cp %{_builddir}/mcelog-183/LICENSE %{buildroot}/usr/share/package-licenses/mcelog/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
