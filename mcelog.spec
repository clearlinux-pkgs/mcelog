...
Version  : 202
Release  : 81
URL      : https://github.com/andikleen/mcelog/archive/v202/mcelog-202.tar.gz
Source0  : https://github.com/andikleen/mcelog/archive/v202/mcelog-202.tar.gz
...
%prep
%setup -q -n mcelog-202
cd %{_builddir}/mcelog-202
%patch -P 1 -p1
pushd ..
cp -a mcelog-202 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1733828758
